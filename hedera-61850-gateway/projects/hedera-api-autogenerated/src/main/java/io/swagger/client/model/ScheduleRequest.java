...
public class ScheduleRequest {
  ...
  public ScheduleRequest registeredInterTies(List<RegisteredInterTie> registeredInterTies) {
    this.registeredInterTies = registeredInterTies;
    return this;
  }

  public ScheduleRequest addRegisteredInterTiesItem(RegisteredInterTie registeredInterTiesItem) {
    this.registeredInterTies.add(registeredInterTiesItem);
    return this;
  }

   /**
   * RegisteredInterTies that have provided capacity assigned, all registered inter ties must be unique within one schedule request.
   * @return registeredInterTies
  **/
  @Schema(required = true, description = "RegisteredInterTies that have provided capacity assigned, all registered inter ties must be unique within one schedule request.")
  public List<RegisteredInterTie> getRegisteredInterTies() {
    return registeredInterTies;
  }

  public void setRegisteredInterTies(List<RegisteredInterTie> registeredInterTies) {
    this.registeredInterTies = registeredInterTies;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.registeredInterTies, scheduleRequest.registeredInterTies);
  }

  @Override
  public int hashCode() {
    return Objects.hash(registeredInterTies);
  }
