...
import io.swagger.client.model.RequestDirective;
import io.swagger.client.model.ScheduleReference;
...
public class SchedulePostResponse {
  ...
  @SerializedName("scheduleReference")
  private ScheduleReference scheduleReference = null;

  @SerializedName("requestDirectives")
  private List<RequestDirective> requestDirectives = new ArrayList<RequestDirective>();

  public SchedulePostResponse mRID(UUID mRID) {
    this.mRID = mRID;
    return this;
  }
  ...
  **/
  ...
  public SchedulePostResponse scheduleReference(ScheduleReference scheduleReference) {
  ...
  **/
  ...
  public void setScheduleReference(ScheduleReference scheduleReference) {
   ...
   /**
   * Specifies when you must make the next request to specified paths within a the given window.
   * @return requestDirectives
  **/
  @Schema(required = true, description = "Specifies when you must make the next request to specified paths within a the given window.")
  public List<RequestDirective> getRequestDirectives() {
    return requestDirectives;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SchedulePostResponse schedulePostResponse = (SchedulePostResponse) o;
    return Objects.equals(this.mRID, schedulePostResponse.mRID) &&
        Objects.equals(this.scheduleReference, schedulePostResponse.scheduleReference) &&
        Objects.equals(this.requestDirectives, schedulePostResponse.requestDirectives);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mRID, scheduleReference, requestDirectives);
  }
  ...
  public String toString() {
    ...
    sb.append("class SchedulePostResponse {\n");
    ...
    sb.append("    requestDirectives: ").append(toIndentedString(requestDirectives)).append("\n");
    sb.append("}");
    return sb.toString();
  }
