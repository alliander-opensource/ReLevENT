...
/**
 * The unit symbol is the symbol of value &#x60;points.quantity&#x60;.
 */
@JsonAdapter(UnitSymbol.Adapter.class)
public enum UnitSymbol {
  ...
  public static UnitSymbol fromValue(String input) {
    for (UnitSymbol b : UnitSymbol.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnitSymbol> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnitSymbol enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public UnitSymbol read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return UnitSymbol.fromValue((String)(value));
    }
  }
}
