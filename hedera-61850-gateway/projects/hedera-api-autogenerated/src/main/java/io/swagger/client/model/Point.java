 ...
 */
@Schema(description = "Containing the values of the time series.")
...
public class Point {
  ...
  public Point position(Integer position) {
    this.position = position;
    return this;
  }

   /**
   * The period of the time series relative to the start time. The start and end that this point represents can be calculated as such: &#x60;start &#x3D; timeSeries.period.timeInterval.start + (timeSeries.period.resolution * position)&#x60; &#x60;end &#x3D; timeSeries.period.timeInterval.start + (timeSeries.period.resolution * (position + 1))&#x60; (non inclusive) 
   * @return position
  **/
  @Schema(example = "4000", required = true, description = "The period of the time series relative to the start time. The start and end that this point represents can be calculated as such: `start = timeSeries.period.timeInterval.start + (timeSeries.period.resolution * position)` `end = timeSeries.period.timeInterval.start + (timeSeries.period.resolution * (position + 1))` (non inclusive) ")
  ...
  public void setPosition(Integer position) {
   ...
   /**
   * Gives the Market Participant insight in why this limit has been set.
   * @return reason
  **/
  @Schema(example = "2001", description = "Gives the Market Participant insight in why this limit has been set.")
  public String getReason() {
    return reason;
  }

  public Point quantity(Double quantity) {
    this.quantity = quantity;
    return this;
  }

   /**
   * The quantity (value) of the point. Should be multiplied by &#x60;quantity.unitMultiplier&#x60; and is of unit type &#x60;quantity.unitSymbol&#x60;. Quantity always represents Firm and Non Firm capacity.
   * @return quantity
  **/
  @Schema(example = "3.5", required = true, description = "The quantity (value) of the point. Should be multiplied by `quantity.unitMultiplier` and is of unit type `quantity.unitSymbol`. Quantity always represents Firm and Non Firm capacity.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Point point = (Point) o;
    return Objects.equals(this.position, point.position) &&
        Objects.equals(this.reason, point.reason) &&
        Objects.equals(this.quantity, point.quantity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(position, reason, quantity);
  }
