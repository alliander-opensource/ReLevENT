...
/**
 * The unit multiplier is the multiplication factor of the relative value.
 */
@JsonAdapter(UnitMultiplier.Adapter.class)
public enum UnitMultiplier {
  ...
  public static UnitMultiplier fromValue(String input) {
    for (UnitMultiplier b : UnitMultiplier.values()) {
  ...
  public static class Adapter extends TypeAdapter<UnitMultiplier> {
    @Override
    public void write(final JsonWriter jsonWriter, final UnitMultiplier enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public UnitMultiplier read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return UnitMultiplier.fromValue((String)(value));
    }
  }
}
