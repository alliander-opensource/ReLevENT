...
public class NotAcceptable {
  ...
  private List<String> acceptable = new ArrayList<String>();

  public NotAcceptable acceptable(List<String> acceptable) {
    this.acceptable = acceptable;
    return this;
  }

  public NotAcceptable addAcceptableItem(String acceptableItem) {
    this.acceptable.add(acceptableItem);
    return this;
  }

   /**
   * Describes options that are acceptable.
   * @return acceptable
  **/
  @Schema(required = true, description = "Describes options that are acceptable.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NotAcceptable notAcceptable = (NotAcceptable) o;
    return Objects.equals(this.acceptable, notAcceptable.acceptable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acceptable);
  }
